...
Script __SQL__, para crear tablas en __MySQL__ del proyecto
finanzas personales.
...
Una forma rápida de crear tablas a nuestra base de datos
es mediante un __script SQL__,
donde estén definidas correctamente las tablas y no allá
errores de sintaxis.
Para ejecutar un archivo con __script SQL__, ejecutemos
